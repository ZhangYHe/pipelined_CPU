...
HD_PWD='D:/Pipelined_CPU_RISCV/pipeline_cpu_riscv.runs/clk_50M_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_50M.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_50M.tcl
